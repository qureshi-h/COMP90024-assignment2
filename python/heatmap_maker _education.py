...
regionTweets = requests.get("http://admin:admin@172.26.133.72:5984/tweets/_design/CountSpecs/_view/RegionTweetDisplay?key=\"education\"")
regionTweetsJson = json.loads(regionTweets.text)

regionAurinData = requests.get("http://admin:admin@172.26.133.72:5984/lga_profiles/_design/Stats/_view/Education")
...
df["Percentage of higher education qualifications"] = 0
...
for index, row in df.iterrows():
    for regions in regionAurinJson["rows"]:
        if row["LGA_NAME"]==regions["key"]:
            ...
            df.at[index,'Percentage of higher education qualifications'] = regions["value"]["Percentage of higher education qualifications"]
    ...
    feature = folium.features.GeoJson(
        ...
        tooltip=folium.features.GeoJsonTooltip(
            fields=[
                ...
                'Percentage of higher education qualifications',
            ],
            aliases=[
                "Percentage of 19 year olds completed year 12: ",
                "Percentage of higher education qualifications: ",
...
heat_map.save('plots/educationHeatMap.html')
print("plots/educationHeatMap.html", end="")